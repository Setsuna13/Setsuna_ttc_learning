...
from core.auxil import configure_nccl,configure_omp,configure_module,get_num_devices
from core.launch import launch
from core.auxil import get_local_rank
def make_parser():
    parser = argparse.ArgumentParser("TTC train parser")
