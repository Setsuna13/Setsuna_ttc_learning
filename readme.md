...
### Train with 6-frame pair augmentation
For the 6-frame pair and reverse TTC augmentation, see [TRAINING_FRAME_PAIR_AUGMENTATION.md](./TRAINING_FRAME_PAIR_AUGMENTATION.md).
